...
const Home = () => {
  ...
  return (
    <section className="flex flex-col text-gray-500 ms:w-full gap-7">
      {/* UPLOAD */}
      <div className="w-full h-[250px] bg-white dark:bg-customDark4 rounded-xl text-gray-500 border dark:border-gray-700 overflow-hidden">
        ...
        {/* post input */}
        <div className="flex items-center w-full gap-5 px-5 mt-10">
          <img
            src={jenna}
            alt="profile_pic"
          ...
          <input
            ...
            className="outline-none text-[0.85rem] dark:bg-customDark4"
          />
        </div>
      ...
      {/* POSTS 1*/}
      <div className="flex flex-col w-full gap-5 p-4 bg-white dark:bg-customDark4 dark:text-gray-300 rounded-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={dan} alt="dan" className="w-[40px] rounded-full" />
            <div className="flex flex-col gap-0 ">
              <h1 className="text-[0.85rem] font-medium dark:text-white">
                Dan Walker
              </h1>
        ...
        <p className="text-[0.9rem]">
          Yesterday with{" "}
          <span className="font-medium dark:text-customBlue">
            @Karen Miller
          </span>{" "}
          and <span className="font-medium dark:text-customBlue">@Marvin </span>
          Stemperd at the{" "}
          <span className="font-medium dark:text-customBlue">
            #Rock'n'Rolla
          </span>{" "}
          ...
          <div className="flex items-center gap-[90px]">
            <div className="relative flex items-center gap-3">
              ...
              <img
                src={david}
                alt="david"
                className="w-[35px] h-[35px] rounded-full absolute left-6"
              />
              <img
                src={edward}
                alt="ed"
                className="w-[35px] h-[35px] rounded-full absolute left-[50px]"
              />
              <img
                src={milly}
                alt="milly"
                className="w-[35px] h-[35px] rounded-full absolute left-[73px]"
              />
            </div>
      ...
      {/* POSTS 2*/}
      <div className="flex flex-col w-full gap-5 p-4 bg-white dark:text-gray-300 dark:bg-customDark4 rounded-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
        ...
        {/* image */}
        <div className="flex items-start w-full gap-3 p-3 bg-whiteBg dark:bg-customDark2">
          <img
            src={bootstrap}
            alt="bootstrap"
            className="rounded-xl h-[120px] w-[250px] object-cover"
          />
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[0.75rem]">YOUTUBE.COM</p>
          </div>
        </div>
      ...
      <div className="flex flex-col w-full gap-5 p-4 bg-white dark:text-gray-300 dark:bg-customDark4 rounded-xl">
        ...
        <p className="text-[0.9rem]">
          Thanks a lot to{" "}
          <span className="font-medium dark:text-customBlue">@Gaelle</span> and{" "}
          <span className="font-medium dark:text-customBlue">@Rolf</span> for
          ...
          <div className="flex items-center gap-[120px]">
            <div className="relative flex items-center gap-3">
              ...
              <img
                src={elise}
                alt="elise"
                className="w-[35px] h-[35px] rounded-full absolute left-[80px]"
              />
              <img
                src={david}
                alt="david"
                className="w-[35px] h-[35px] rounded-full absolute left-[100px]"
              />
            </div>
      ...
      <div className="flex flex-col w-full gap-5 p-4 bg-white dark:bg-customDark4 dark:text-gray-300 rounded-xl">
        ...
        {/* article */}
        <p className="text-[0.9rem]">
          Just discovered this awesome CSS framework named #bulmaCss. It's based
          on flexbox, so easy to use and comes with so many mobile first
          modifiers. You can build anything from scratch easily with Bulma.{" "}
          <span className="font-medium dark:text-customBlue">
            #webdesign #bulmaio
          </span>
        </p>
        ...
        <div className="flex items-start w-full gap-3 p-3 bg-whiteBg dark:bg-customDark2">
          ...
          />
          <div className="flex flex-col gap-2">
            <h1 className="text-[1rem] font-medium">Bulma CSS Framework</h1>
            <p className="text-[0.85rem]">
              Bulma is a mobile first CSS framework built on top of Flexbox.
              It's awesome and so easy to use.
            </p>
            <p className="text-[0.75rem]">BULMA.IO</p>
          </div>
        </div>
      ...
      <div className="flex flex-col w-full gap-5 p-4 bg-white dark:bg-customDark4 dark:text-gray-300 rounded-xl">
        ...
        {/* INTERRACTIONS */}
        <div className="relative flex items-center justify-between w-full py-2 pt-4">
          <div className="flex items-center gap-[45px]">
            <div className="relative flex items-center gap-3">
              <img
                src={daniel}
      ...
      <button className="w-[150px] m-auto border my-[80px] py-2 bg-white dark:bg-customDark4 dark:text-gray-400 dark:border-none">
        Load More
      </button>
      ...
      {isAlbumOpen && (
        <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full">
          ...
          <div className="p-3 px-4 pb-5 w-[500px] text-[0.85rem] text-gray-500 bg-white dark:bg-customDark4 z-10 flex flex-col gap-3 rounded-xl items-center text-center">
            <div className="flex items-center justify-between w-full py-2 border-b dark:border-gray-700">
            ...
            <button className="w-[150px] m-auto bg-customBlue text-white outline-none rounded-xl p-2">
              Next
            </button>
          </div>
        </div>
