  ...
  return (
    <div className="h-[100vh] w-[100vw] bg-whiteBg">
      ...
      <div className=" my-8 flex items-center justify-center gap-20 text-[1.2rem] text-gray-400">
        <div className={`${tab === "welcome" ? 'border border-blue-500 text-blue-500' : ''} w-[35px] h-[35px] rounded-full bg-white flex items-center justify-center cursor-pointer`}>
          <CiFaceSmile />
        </div>
        <div className="w-[35px] h-[35px] rounded-full bg-white flex items-center justify-center cursor-pointer">
          <IoPersonOutline/>
        </div>
        <div className="w-[35px] h-[35px] rounded-full bg-white flex items-center justify-center cursor-pointer">
          <HiOutlinePhoto />
            ...
            <div className="flex flex-col items-center justify-center gap-10 w-full">
              ...
              <div className="flex items-center justify-center gap-7 w-full">
                <div className="flex items-center flex-col justify-center gap-7">
                  <div className="relative p-8 bg-white rounded-xl w-[350px] object-contain h-[400px] bg-car-img bg-no-repeat object-center">
                    ...
                    <button className="text-[0.85rem] text-gray-500 w-full border p-2">continue</button>
                  </div>
                </div>

                <div className="flex items-center flex-col justify-center gap-7">
                  <div className="relative p-8 bg-white rounded-xl w-[350px] object-contain h-[400px] bg-bg-img-4 bg-no-repeat object-center">
                ...
                <div className="flex items-center flex-col justify-center gap-7">
                  <div className="relative p-8 bg-white rounded-xl w-[350px] object-contain h-[400px] bg-bg-img-5 bg-no-repeat object-center">
