...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="fixed top-0 z-[999] w-full">
      <div className="dark:bg-customDark1 dark:border-none dark:text-white w-full h-[60px] flex items-center justify-between border-b px-3 bg-white relative ">
        ...
        <div>
          {
            islikesOpen && (
              <div className="dark:bg-customDark1 dark:border-none dark:text-gray-500 absolute flex flex-col gap-4 bottom-[-560px] ms:left-[90px] left-10 bg-white w-[350px] border shadow-md rounded-xl z-[9999]">
        ...
        <div>
          {
            isnotiOpen && (
              <div className="dark:bg-customDark1 dark:border-none dark:text-gray-500 absolute flex flex-col gap-4 bottom-[-410px] ms:left-[130px] left-10 bg-white w-[350px] border shadow-md rounded-xl z-[9999]">
                <div className="flex justify-between border-b px-5 py-4 dark:border-gray-700">
        ...
        {/* messages */}
          <div>
            {
              ismessageOpen && (
                <div className="dark:bg-customDark1 dark:text-gray-500 dark:border-none absolute flex flex-col gap-4 bottom-[-430px] ms:left-[200px] left-10 bg-white w-[350px] z-[9999] border shadow-md rounded-xl">
                  <div className="flex justify-between border-b px-5 py-4 dark:border-gray-700">
        ...
        <div>
          {
            isexploreOpen && (
              <div className="dark:text-gray-400 dark:bg-customDark3 w-full h-[100vh] bg-white z-[999] fixed left-0 top-[60px] flex px-8 ms:px-0">
                <div className="w-full max-w-[900px] mx-auto h-full py-6 ">
                  <div className="flex items-center justify-between w-full gap-5 ms:gap-0">
