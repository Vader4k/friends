...
const Leftbar = () => {
  return (
    <section className="flex-1 hidden ms:flex ms:flex-col gap-6 md:ml-0 ml-3 ">
      ...
      {/* RECOMMENDED PAGES */}
      <div className="flex flex-col w-[full] bg-white dark:bg-customDark4 dark:text-white h-[450px] rounded-xl py-3">
        <div className="p-3 flex items-center justify-between text-gray-500 text-[0.9rem] border-b dark:border-gray-700">
          <h1 className="dark:text-white">Recommended Pages</h1>
          <HiOutlineDotsVertical className="dark:text-gray-500"/>
        </div>
        <div className="w-full flex justify-between items-center p-4 border-b dark:border-gray-700">
          <div className="flex items-center gap-3">
            <img src={pizza} alt="pizza" className="w-[40px] rounded-full"/>
            <div className="flex flex-col gap-1">
              <h1 className="text-[0.85rem] font-medium">Fast Pizza</h1>
              <p className="text-[0.8rem] text-gray-500 dark:text-gray-500">Pizza & Fast Food</p>
            </div>
          </div>
          <div>
            <CiBookmark className="text-[1.2rem] dark:text-gray-500"/>
          </div>
        </div>
        ...
        <div className="w-full flex justify-between items-center p-4 border-b dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[0.8rem] text-gray-500 dark:text-gray-500">Technology</p>
            </div>
          </div>
          <div>
            <CiBookmark className="text-[1.2rem] dark:text-gray-500"/>
        ...
        <div className="w-full flex justify-between items-center p-4 border-b dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[0.8rem] text-gray-500 dark:text-gray-500">Movies / Entertainment</p>
            </div>
          </div>
          <div>
            <CiBookmark className="text-[1.2rem] dark:text-gray-500"/>
        ...
        <div className="w-full flex justify-between items-center p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[0.8rem] text-gray-500 dark:text-gray-500">web / Design</p>
            </div>
          </div>
          <div>
            <CiBookmark className="text-[1.2rem] dark:text-gray-500"/>
      ...
      {/* ADS */}
      <div className="w-full p-3 rounded-xl bg-white relative dark:bg-customDark4 dark:text-gray-500">
        <p className="text-[0.7rem] text-gray-500 absolute top-0 right-3">ADS VIA NINJA</p>
      </div>

      {/* ACTIVITIES */}
      <div className="w-full flex flex-col gap-3 bg-white dark:bg-customDark4 dark:text-gray-500 rounded-xl py-3">
        <div className="p-3 flex items-center justify-between text-gray-500 text-[0.9rem] border-b dark:border-gray-700">
          <h1 className="dark:text-white">Latest activity</h1>
          <HiOutlineDotsVertical />
        </div>

        <div className="w-full flex justify-between items-center px-4 pb-3 border-b dark:border-gray-700">
          <div className="flex items-center gap-3">
            <img src={hanzo} alt="hanzo" className="w-[40px] rounded-full"/>
            <div className="flex flex-col gap-1">
              <h1 className="text-[0.85rem] font-medium dark:text-white">Css Ninja</h1>
        ...
        <div className="w-full flex justify-between items-center px-4 pb-3 border-b dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              <h1 className="text-[0.85rem] font-medium dark:text-white">Milly Augustine</h1>
        ...
        <div className="w-full flex justify-between items-center px-4 pb-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              <h1 className="text-[0.85rem] font-medium dark:text-white">Nuclearjs</h1>
